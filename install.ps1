...
Write-Host @"
  ...
  Next Steps / 后续步骤:
  - Start services / 启动服务:    node .\sclaw docker-start
  - Stop services / 停止服务:     node .\sclaw docker-stop
  - View logs / 查看日志:         node .\sclaw docker-logs
  - View status / 查看状态:       node .\sclaw docker-status
