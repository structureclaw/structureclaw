...
export interface ContextPayload {
  ...
  /** Optional model format identifier */
  modelFormat?: string
  ...
  /** Optional design code */
  designCode?: string
  /** Optional elements for code checking */
 ...
 */
export type StreamFrameType = 'start' | 'token' | 'interaction_update' | 'result' | 'done' | 'error'
