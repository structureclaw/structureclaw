...
function resolveWorkerPath(): string {
  const candidates = [
    path.resolve(process.cwd(), 'backend/src/agent-skills/analysis/python/worker.py'),
    path.resolve(process.cwd(), 'src/agent-skills/analysis/python/worker.py'),
    path.resolve(__dirname, '../../agent-skills/analysis/python/worker.py'),
  ];
