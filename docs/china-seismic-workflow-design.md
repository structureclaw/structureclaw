...
| Ground-motion parameters | `GB 18306-2015 Seismic Ground Motion Parameter Zonation Map of China` | Current official standard; SAMR also lists revision plan `20260055-Q-419` as drafting, so draft/revision-plan content must not be used as formal design basis until it replaces the current standard. |
